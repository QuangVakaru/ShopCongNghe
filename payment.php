							...
							<div id="tab4" class="tab-grid" style="display: block;">
								<div class="row">
									<div class="col-md-6 pay-forms">
										<img class="pp-img" src="images/zalopay.jpg" alt="Image Alternative text" title="Image Title">
										<p>Important: You will be redirected to PayPal's website to securely complete your payment.</p>
										<a class="btn btn-primary" href="https://id.zalo.me/account?continue=https%3A%2F%2Fchat.zalo.me%2F">Checkout via Zalopay</a>
									</div>
